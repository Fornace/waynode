...
tests=(
  ...
  "WaynodeUITests/testActiveRunKeepsStopAvailableWhileOfferingQueue"
  "WaynodeUITests/testHistoryFailureBlocksFalseEmptyStateAndOffersRetry"
  ...
  "WaynodeUITests/testCloneUsesSelectedViewerOrganization"
  ...
  "AccountUITests/testAccountSheetOpensAndClosesFromWorkbench"
  "AccountUITests/testAccountBillingAndTokenCreationUseProductionSheets"
  "AccountUITests/testAccountSelfHostedBillingIsExplicit"
  "AccountUITests/testViewerOrganizationCannotManageHostedBilling"
  "AccountUITests/testBillingCapabilityFailureIsNotSelfHosted"
  "AccountUITests/testTokenRevocationCanCancelAndConfirm"
  "AccountUITests/testLogoutCanCancelAndConfirm"
  ...
  "GitTerminalUITests/testDetachedHeadBlocksUnsafeSynchronization"
  "GitTerminalUITests/testNoUpstreamBlocksPullButKeepsRecoveryPushAvailable"
  "GitTerminalUITests/testGitSheetOpensAndClosesFromSession"
  "GitTerminalUITests/testTerminalFailureAndExitStatesAreRecoverable"
  "GitTerminalUITests/testTerminalDoesNotClaimConnectedBeforeHandshake"
)
