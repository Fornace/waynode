...
export WAYNODE_UI_ONLY="IPadResponsiveUITests/testRegularWidthWorkbenchSurvivesPortraitAndLandscape,IPadResponsiveUITests/testNewSessionSheetKeepsKeyboardAndActionsReachable"
