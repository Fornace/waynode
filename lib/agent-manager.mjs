...
export async function getTerminal(session, spawnPty = runPiTerminal) {
  ...
  // needs a long-lived bidirectional pty — which the microsandbox 0.5.7 SDK
  // does not expose cleanly (execStream buffers; shellStream delivers no
  // output for pi; ssh attach() has no documented programmatic read/write).
