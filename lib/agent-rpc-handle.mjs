...
export class AgentHandle {
  ...
  async sendPrompt(prompt, isGoal = false, submissionId) {
    ...
    try {
      await this._send({ type: "prompt", message: goalPrompt(prompt, isGoal) });
    } catch (error) {
      this.streaming = false;
      this.currentSubmission = null;
  ...
  queueFollowUp(prompt, isGoal = false, submissionId) {
    ...
    this._send({ type: "follow_up", message: goalPrompt(prompt, isGoal) }).catch((error) => {
